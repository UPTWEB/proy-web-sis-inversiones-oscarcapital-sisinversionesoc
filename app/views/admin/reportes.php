...
<body>
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-8 mb-4 mb-md-0"> <!-- Aumentado a 8 columnas -->
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Inversiones por Cliente</h5>
                                </div>
                                <div class="card-body">
                                    <canvas id="graficoTopClientes" height="140"></canvas> <!-- Altura aumentada -->
                                </div>
                            </div>
                        </div>

                        <!-- Gráfico de pastel (más compacto) -->
                        <div class="col-md-4"> <!-- Reducido a 4 columnas -->
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Pagos del Mes</h5>
                                </div>
                                <div class="card-body text-center">
                                    <canvas id="graficoPiePagos" width="150" height="150" style="max-width: 100%; height: auto;"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const dataEstadoPagos = <?= json_encode($dataEstadoPagos); ?>;

        const labelsTopClientes = <?= json_encode($labelsTopClientes) ?>;
        const dataTopClientes = <?= json_encode($dataTopClientes) ?>;
    </script>
