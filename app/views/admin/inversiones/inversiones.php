                ...
                <div class="container-fluid mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <a href="/export/inversiones/csv" class="btn btn-info text-white">CSV</a>
                            <a href="/export/inversiones/excel" class="btn btn-success">EXCEL</a>
                                ...
                                <?php if (!empty($inversiones)): ?>
                                    <?php foreach ($inversiones as $i): ?>
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($i['fecha_calculada']) ?></td>
                                            <td>
                                                <?php
                                                $plan = (int)htmlspecialchars($i['plan_inversion']);
                                                switch ($plan) {
                                                    case 1:
                                                        echo "Mensual";
                                                        break;
                                            ...
                                            <td>
                                                <a href="/inversiones/<?= htmlspecialchars($i['id']) ?>" class="btn btn-success btn-sm">Ver</a>
                                                <form action="/inversiones/eliminar" method="POST" style="display:inline;">
