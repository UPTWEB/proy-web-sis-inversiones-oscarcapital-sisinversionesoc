            ...
            <main class="content px-3 py-2">
                <div class="container-fluid mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div>
                            <a href="/export/pagosEfectuados/csv" class="btn btn-info text-white">CSV</a>
                            <a href="/export/pagosEfectuados/excel" class="btn btn-success">EXCEL</a>
                                ...
                                <?php if (!empty($pagos)): ?>
                                    <?php foreach ($pagos as $i): ?>
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($i['numero_pago']) ?></td>
                                            <td><?= htmlspecialchars($i['fecha']) ?></td>
                                            <td>
                                                <a href="/pagos/<?= htmlspecialchars($i['id'])?>" class="btn btn-primary btn-sm w-50">Ver Pago</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
